...
const bottone = (href, testo) =>
  `<p style="margin:28px 0"><a href="${href}" style="background:#0C5A30;color:#fff;padding:12px 22px;border-radius:8px;text-decoration:none;font-weight:600">${testo}</a></p>`;
