...
**12.Y — VETRINA A CATALOGO PER CATEGORIE (superata da 12.Y.1 per l'impalcatura; restano validi il formato voce e la marcatura «in arrivo»).**
...
**12.Y.1 — CATALOGO PER FAMIGLIE, NON PER PILASTRI (22/08/2026). Sostituisce l'impalcatura di 12.Y.**
- LE TRE FAMIGLIE, per NATURA della qualifica: MISURA E RENDICONTA (carbon nei due tagli, VSME base e avanzato, rating circolarita, monitoraggio energetico), SISTEMI CERTIFICABILI (ISO 9001, 14001, 45001, UNI/PdR 125, SA8000, ISO 21401, ISO 20121 e gli add-on 45003, 30415, 26000/20400), QUALIFICA E ACCESSO (profilo ESG per questionari e rating, check-up energetico, supporto all'audit). I pilastri E/S/G reggevano come tassonomia e non come guida alla scelta — e facevano comparire ISO 9001 e ISO 14001 in DUE famiglie, che e il modo piu rapido di far credere che siano due servizi diversi. Ora ogni servizio compare una volta sola e il pilastro resta come ETICHETTA DISCRETA sulla scheda.
- OGNI FAMIGLIA SI APRE DICENDO COSA OTTIENI, mai cosa contiene: una famiglia che si presenta con l'elenco di se stessa non aiuta a scegliere. `ottieni` per la testata, `sintesi` (mezza riga) per lo schema in cima — scritta, non ricavata tagliando la prima alla punteggiatura.
- SCHEMA IN TESTA (`SchemaQualifica`): tre piani impilati — chi ti chiede di dimostrare (banca, capofiliera, stazione appaltante, cliente finale, organismo) → la tua impresa → le tre famiglie come risposte. Non una raggiera: su schermo stretto diventerebbe illeggibile o andrebbe scritta due volte, e la gerarchia chi-chiede/chi-risponde e gia verticale. Il messaggio da far arrivare in tre secondi: questi servizi qualificano l'impresa davanti a chi la valuta.
- PREZZI SEMPRE «A PARTIRE DA» in vetrina, con «varia per dimensione d'impresa» accanto: un prezzo secco sembra valido per tutti e il listino e per fascia. Il valore e quello della fascia micro e viene da `pricing.ts`, mai scritto a mano; il prezzo esatto si compone nella pagina del percorso.
- GERARCHIA DELLA SCHEDA, in quest'ordine perche e l'ordine in cui si decide: nome tecnico completo (§12.I) → riga di beneficio in lingua corrente → norma di riferimento → prezzo «a partire da» → stato (attivo / In arrivo) e via d'uscita. Icona coerente per famiglia. Le voci in arrivo non hanno prezzo ne link: dicono solo che arriveranno.
- FILTRO PER BISOGNO: quattro situazioni reali — me lo chiede la banca, me lo chiede un committente, partecipo a un bando, voglio migliorare — dichiarate su ogni voce in `bisogni`. La dichiarazione dev'essere sostenibile con quello che la scheda del servizio gia scrive, mai un'etichetta messa li per riempire il filtro. Il filtro TOGLIE e non aggiunge: senza JavaScript resta il catalogo intero, che e lo stato di partenza.

**12.Y.2 — LA SCHEDA SERVIZIO E UN DISCORSO, NON UNA PILA DI RIQUADRI (22/08/2026).**
- ORDINE DI LETTURA, uno solo: (1) che cos'e e A CHI SERVE — `cosE` piu `perChi`, che prima viveva solo dentro «In breve»; (2) COME LO PRODUCIAMO, che raccoglie cio che era sparso in cinque riquadri affiancati — cosa serve dall'impresa piu i requisiti, il lavoro passo per passo, cosa si riceve e com'e fatto, su quali norme, dove si ferma il perimetro; (3) CHE COSA TI APRE (opportunita); (4) il prezzo, UNA VOLTA SOLA, nel selettore per fascia; (5) le domande frequenti in fondo. Gerarchia vera: h1 per il nome, h2 per le tre sezioni piu le domande, h3 per i passi — prima erano paragrafi in font display, cioe titoli finti.
- IL BLOCCO «IN BREVE» NON C'E PIU IN CIMA, ma il suo contenuto non si e perso: e diventato la sezione DOMANDE FREQUENTI in fondo (`DomandeFrequenti`), con la stessa fonte (`faqServizio`) e la stessa marcatura FAQPage. Stava in alto per servire chi arriva da una risposta generata, e produceva l'effetto opposto: si leggeva due volte la stessa cosa nello spazio di due schermate, prima in breve e poi per esteso.
- LA RIPETIZIONE RESTA, MA DICHIARATA. Le domande in fondo sono la forma ESTRAIBILE delle stesse informazioni — quella che serve a un assistente che risponde al posto della pagina — e la riga di apertura del blocco lo dice al lettore invece di lasciarglielo scoprire. Il PREZZO compare percio due volte: una come selettore (l'unica resa interattiva) e una come frase autoconclusiva nelle domande. E l'unica sovrapposizione ammessa, ed e voluta.
- IL MARKUP COMBACIA CARATTERE PER CARATTERE con le domande visibili: una fonte sola passata sia al componente sia a `jsonLdFaq`. Verificato per tutti i percorsi, non a campione.
- PERIMETRO: resta in evidenza (§12.M) ma dentro «come lo produciamo», come sua chiusa («Dove si ferma»), perche e il confine di cio che si produce e li si legge in fila con il resto — non come postilla in fondo.

**12.Y.3 — LA TESTATA DI /SERVIZI PORTA FATTI, NON PREMESSE (22/08/2026).**
- LO SCHEMA «QUALCUNO TI CHIEDE UNA PROVA» E STATO RIMOSSO: diceva in forma astratta (chi ti valuta → la tua impresa → le tre famiglie) quello che il selettore per situazione fa gia in concreto due schermate piu giu. Era vero e non portava informazione.
- AL SUO POSTO QUATTRO FATTI VERIFICABILI sul perche le richieste di dati alle imprese aumentano, ciascuno con la fonte, cosa comporta per l'impresa e i percorsi pertinenti (`src/lib/richieste.ts`, componente `PercheChiedono`): (1) le linee guida EBA sulla gestione dei rischi ESG — EBA/GL/2025/01 del 9 gennaio 2025, §24 e §25 — chiedono alle banche di raccogliere dati ESG a livello di singolo cliente e indicano per le PMI non quotate lo standard volontario, applicabili dall'11 gennaio 2026 (dall'11 gennaio 2027 per gli enti piccoli e non complessi); (2) la Direttiva (UE) 2026/470 del 24 febbraio 2026 («Omnibus I») fissa il limite di catena del valore — a un'impresa fino a 1.000 dipendenti non si puo chiedere piu di quanto previsto dallo standard volontario; (3) il D.Lgs. 36/2023 art. 108 comma 7 impone alle stazioni appaltanti il maggior punteggio a chi possiede la certificazione della parita di genere, e dal DL 57/2023 l'autocertificazione non basta; (4) CDP dichiara che nel 2025 oltre 270 grandi acquirenti hanno chiesto a circa 45.000 fornitori nel mondo di rendicontare tramite il programma Supply Chain.
- REGOLA GENERALE, annotata anche in CLAUDE.md: si verifica prima di scrivere; se una fonte non regge la riga si TOGLIE invece di genericizzarla; il link va alla fonte ufficiale e mai a un riassunto; il file dei dati porta la data dell'ultima verifica. Sotto le tre righe solide, la sezione si elimina e il selettore parla da solo.
- IL SELETTORE PER SITUAZIONE resta invariato: e la parte che funziona.

**12.Y.4 — /GUIDE, E IL CATALOGO CHE CONTIENE SOLO IL CATALOGO (22/08/2026). Sostituisce 12.Y.3 per la collocazione.**
- IL CONTESTO NORMATIVO ESCE DA /SERVIZI. I quattro fatti con le norme citate erano corretti e verificati, e stavano nel posto sbagliato: un catalogo contiene i servizi, il prezzo, cosa tratta ciascuno e il modo di scegliere. Chi apre /servizi ha gia deciso di guardare cosa vendiamo; una lezione di contesto davanti all'elenco allunga la strada verso l'unica cosa che era venuto a fare.
- NUOVA SEZIONE /GUIDE, fuori dal menu principale: si raggiunge dal footer e dai rimandi contestuali — uno solo su /servizi, uno solo nella barra delle pagine correlate di ogni scheda («Perche te lo chiedono», alla guida pertinente). Fuori dal menu perche la navigazione principale porta a cio che vendiamo e cinque voci sono gia il massimo; e perche queste pagine sono scritte per essere TROVATE cercando la domanda, non navigando il sito.
- UNA GUIDA PER DOMANDA. Il titolo E la domanda come la farebbe un'impresa («perche la banca mi chiede…», non «gli obblighi ESG per il credito»); la risposta autoconclusiva sta in APERTURA, perche chi arriva ha gia la domanda in testa e perche un assistente che cita la pagina prende le prime righe, non le ultime. Poi: cosa comporta, la fonte da aprire, i percorsi che rispondono. Dati strutturati `Article` (non `BlogPosting`: sono schede di fatto, non post datati) piu `FAQPage` con l'unica coppia visibile, carattere per carattere, piu `BreadcrumbList`. La data dell'ultima verifica delle fonti sta IN PAGINA.
- NIENTE PARAGRAFO «IL FATTO»: c'era, e ripeteva l'apertura parola per parola due paragrafi piu sotto. La risposta autoconclusiva e gia il fatto per esteso — la stessa ridondanza corretta nelle schede servizio, ricomparsa qui perche il testo era nato altrove.
- SOPRA IL SELETTORE, LA MAPPA DEL CATALOGO (`MappaCatalogo`): tre blocchi, uno per famiglia, con icona, nome, UNA riga su cosa ottieni (`sintesi`), quanti percorsi attivi e quanti in arrivo, e i nomi dei primi tre come anteprima — con il taglio aggiunto solo dove due percorsi hanno lo stesso nome. Niente norme, niente contesto, niente elenchi di chi chiede cosa: e una mappa, non un ragionamento. Sta DENTRO il componente del catalogo, non accanto: cliccando un blocco si azzera il filtro e si scorre alla famiglia — un semplice link ad ancora, con un filtro attivo, punterebbe a una sezione che in quel momento non esiste.
- TRE LAVORI DISTINTI, in fila e senza sovrapposizioni: la MAPPA mostra la struttura, il SELETTORE filtra per situazione, il CATALOGO elenca. Il Percorso Ver0 sta in testa al catalogo, DOPO il selettore (prima interrompeva la sequenza), e il filtro lo riguarda: la sua riga «a chi serve» nomina banca, capofiliera e bandi, e mostrarlo a chi ha scelto «voglio migliorare» sarebbe una risposta fuori tema.

**12.Y.5 — LE GUIDE, E LE DESIGNAZIONI DELLE NORME (24/08/2026).**
- SETTE GUIDE in /guide: le quattro nate dai fatti normativi piu tre scritte ex novo — quanto costa e cosa serve per un bilancio VSME, che cosa si misura in una carbon footprint di organizzazione, che cosa contiene il manuale ISO 9001 e chi lo puo preparare. Ogni guida: titolo = la domanda reale, risposta autoconclusiva in apertura, corpo solo dove c'e qualcosa da spiegare (le prime quattro non ce l'hanno, e va bene cosi), «cosa comporta», fonte ufficiale, domande in fondo marcate in `FAQPage` insieme a quella del titolo, percorsi pertinenti e guide collegate. Nessun contenuto di riempimento e nessuna checklist documento-per-norma: si informa, non si regala il metodo.
- LE DESIGNAZIONI DELLE NORME SI RIVERIFICANO, e il 24/08/2026 tre erano superate in catalogo e nel generatore di bozze: UNI EN ISO 9001:2015 (ritirata, ora +A1:2024 dal 16 ottobre 2024), UNI EN ISO 14001:2015 (ritirata, ora UNI EN ISO 14001:2026 dal 15 aprile 2026), UNI ISO 45001:2018 (ritirata dal 28 settembre 2023, ora UNI EN ISO 45001:2023+A1:2024). Fonte: store.uni.com, che e l'autorita sulla designazione italiana. L'elenco con le date sta in testa a `src/lib/catalog.ts` e va ricontrollato periodicamente: una designazione superata su una pagina che vende conformita e la peggiore figura possibile.

**12.A — OSSERVABILITA, LEAD E MODALITA PRE-LANCIO (20/08/2026).**
- ANALITICA SENZA COOKIE, scelta ibrida e motivata: Vercel Analytics per traffico e sorgenti (gia dove il sito e ospitato, zero manutenzione, nessun cookie) + tabella `events` di prima parte per gli EVENTI DI BUSINESS. Il secondo perche il dato «dove si perdono le persone» deve stare accanto a ordini e lead per essere interrogabile in SQL, essere nostro e in UE, e non dipendere da un piano tariffario. Nessuno dei due usa cookie di profilazione: restano fuori dal consenso, coerentemente con la cookie policy.
- EVENTI tracciati: apertura scheda servizio, click sul pulsante di attivazione, passi del funnel completati, richiesta inviata, contatto inviato, iscrizione alla lista d'attesa. Elenco CHIUSO, validato lato server; del visitatore solo un'impronta con pepper che cambia ogni ora, mai l'IP; nessuna query string, nessun indirizzo email.
- SEARCH CONSOLE e POSTA: stato e regole in 12.A.1.
- NOTIFICHE via Resend a RESEND_NOTIFICHE_A per ogni contatto, richiesta e iscrizione, con i soli dati essenziali e il link al back-office. Al richiedente parte una conferma con riepilogo e la rassicurazione sull'addebito.
- BACK-OFFICE LEAD (/dashboard/lead): nuovo ruolo `amministratore`, RLS con `is_admin()`, imbuto degli ultimi 30 giorni, sorgenti, e le tre liste con stato e note interne. Test RLS a 53: il ruolo non e autoassegnabile, le imprese non leggono eventi/waitlist/contatti, e l'amministratore NON accede agli archivi documenti dei clienti.
- MODALITA PRE-LANCIO: interruttore NEXT_PUBLIC_PAGAMENTI_ATTIVI (default false). L'ultimo passo del funnel e una RICHIESTA DI ATTIVAZIONE — restano prezzo, dimensione e formula perche qualificano il lead, sparisce il metodo di pagamento. Ordine con stato 'richiesta', attivazione 'richiesto', portale che dice «In attesa di avvio». Il flusso di pagamento resta nel codice dietro l'interruttore.
- LE TRE COSE DOPO LA RICHIESTA (fonte unica in `src/lib/avvio.ts`, stesso ordine ovunque — schermata finale, email di conferma, portale): 1) nessun addebito fino all'inizio concordato; 2) ti contattiamo per fissare l'avvio del tuo percorso; 3) nel frattempo due cose utili e circoscritte — confermare i dati recuperati e caricare i documenti gia' in casa. L'invito NON promette un ambiente operativo pieno: si dice «la tua scheda impresa e gia' pronta: dai un'occhiata», mai «entra nel tuo ecosistema». Nel portale i percorsi in stato «richiesto» mostrano quelle due azioni al posto della bozza (che non esiste ancora) e DICHIARANO cosa si sblocca con l'avvio, nominando i documenti per esteso.

**12.A.1 — POSTA E VERIFICA DEL DOMINIO (stato verificato con dig il 20/08/2026).**
- CATENA DI FIRMA IN PRODUZIONE: Resend spedisce con Return-Path su `send.verzero.it` (SPF `v=spf1 include:amazonses.com ~all`, MX `feedback-smtp.eu-west-1.amazonses.com`) e firma DKIM con `d=verzero.it`, selettore `resend`. L'allineamento DMARC lo garantisce il DKIM, NON l'SPF.
- REGOLA VINCOLANTE — NON aggiungere Resend all'SPF della radice. Alla radice resta l'SPF dell'hosting (`include:spf.webapps.net ~all`): l'SPF si valuta sul dominio del Return-Path, quindi quell'include sarebbe inutile e consumerebbe uno dei dieci lookup ammessi. Chi trova quella riga "incompleta" la lasci dov'e.
- DMARC ATTIVO E CON RACCOLTA FUNZIONANTE: `_dmarc.verzero.it` = `v=DMARC1; p=none; rua=mailto:re+cdl2rwllqyv@dmarc.postmarkapp.com` (verificato byte per byte sui due nameserver autoritativi di register.it il 20/08/2026: nessun carattere non-ASCII, un solo record TXT).
- I rapporti vanno a DMARC Digests di Postmark, piano gratuito: nessun account, nessuna carta, digest settimanale leggibile, domini illimitati, 7 giorni di storico consultabile (il piano a pagamento, 14 $/mese per dominio, ne conserva 60 — non ci serve: lo storico sono le email stesse). Nei rapporti aggregati non viaggia contenuto di messaggi ne indirizzi dei destinatari: solo IP dei mittenti, domini, esiti di autenticazione e conteggi.
- PERCHE QUESTO SERVIZIO E NON UN INDIRIZZO QUALSIASI: quando la casella `rua` sta su un dominio diverso da quello del record, la RFC 7489 §7.1 impone a chi genera i rapporti di trovare un TXT `v=DMARC1` su `<dominio>._report._dmarc.<destinazione>`. Postmark lo pubblica come wildcard su `dmarc.postmarkapp.com` (verificato); una casella personale su hotmail.it no, e li nessun reporter conforme spedisce. ATTENZIONE alla documentazione vecchia che mostra indirizzi `@inbound.postmarkapp.com`: quel dominio NON ha l'autorizzazione.
- TRAPPOLA GIA INCONTRATA, da ricordare per ogni record DNS: un valore incollato da pagina web puo portarsi dietro le virgolette tipografiche U+201C/U+201D come parte del contenuto. Il record smette di iniziare per `v=DMARC1` e il dominio risulta SENZA politica DMARC, senza che nessun pannello lo segnali. Si vede solo interrogando gli autoritativi e guardando i byte.
- PROSSIMO PASSO: leggere i primi digest settimanali (con i volumi attuali qualche settimana sara vuota, e normale) e decidere sui dati il passaggio a `p=quarantine`, mai a occhio.
- SEARCH CONSOLE: verificata via record TXT DNS sulla radice (`google-site-verification=Qjcfyr...`), sitemap gia inviata — 24 URL: home, quattro istituzionali, tre legali, indice servizi, quattordici percorsi, Sigillo. Le transazionali (`/acquista/`, `/login`, `/dashboard`) restano fuori da sitemap e da robots.
- La verifica per DNS vale su tutto il dominio, quindi NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION resta VUOTA e il layout non emette alcun meta tag (verificato in produzione). Le due variabili restano nel codice per eventuali proprieta future, senza effetti finche non valorizzate.

**12.X — SISTEMA DI MOVIMENTO E PRIMO IMPATTO (brief di esperienza, 20/08/2026).**
- TRE DURATE E UNA CURVA, in `globals.css`: micro 150ms (risposta a un gesto), stato 250ms (un elemento cambia natura), ingresso 400ms (un blocco entra in scena), scaglionamento 70ms, curva `cubic-bezier(.22,.9,.34,1)`. Le utility Tailwind senza durata esplicita ereditano la micro. Nessuna durata scritta a mano in un componente: c'e uno script di controllo che rilegge il CSS costruito e fallisce se ne compare una.
- QUATTRO STATI per ogni elemento cliccabile, in una classe sola (`.vz-press`, alias `.vz-interattivo`): riposo, hover (sale di 1px e prende ombra), premuto (scende di 1px, 90ms), disabilitato (piatto, spento, senza mano). Nessuno somiglia a un altro.
- REGOLA DI SICUREZZA: ogni regola che nasconde contenuto (opacity 0, tratto non disegnato) vive SOLO dentro `@media (prefers-reduced-motion: no-preference)`. Senza JS, con «riduci movimento» o su un motore che ignora l'animazione, il contenuto e semplicemente li. Un'animazione che puo far sparire un testo e un bug, non un effetto.
- SI ANIMANO SOLO `opacity` E `transform`: sono le due proprieta che il compositor gestisce senza rifare layout ne disegno. Mai larghezze, altezze, ombre o filtri animati — sono il modo piu diretto per pagare un effetto con i Core Web Vitals.
- MAI PIU DI TRE elementi indipendenti in movimento insieme in una schermata. Gli elementi di una stessa lista contano come uno e si scaglionano di 70ms, fermandosi al sesto: da li in poi entrano insieme, perche una lista lunga che si accende a cascata e un'attesa travestita.
- /COME-FUNZIONA — STESSA GRAMMATICA DELLA HOME, non un secondo schema (21/08/2026). La pagina usa LO STESSO COMPONENTE dell'infografica di home (`MotoreInAzione`) con il livello di dettaglio acceso: chi arriva dalla home riconosce il sistema invece di trovarne un altro. Le rappresentazioni verticali precedenti — GHG e ISO 9001 trattate come schemi a se — sono state tolte da qui: erano due grammatiche diverse per la stessa cosa. Lo stesso vale per /chi-siamo, dove lo schema e arrivato subito dopo: `MotoreScrolly` e stato rimosso e con lui i dati che serviva solo a lui (`MOTORE_FASI`, `CAMPI_ESTRATTI`). Tre pagine, una grammatica sola — in /chi-siamo senza il livello di dettaglio, che vive in /come-funziona, e con il rimando esplicito.
- LA PROFONDITA IN PIU: ogni blocco dello schema si apre con `<details>` nativo — accessibile da tastiera senza JS — e dentro c'e il METODO: cosa leggiamo dai documenti, quali banche dati interroghiamo e con quale mandato (revocabile), come componiamo secondo la struttura della norma, dove interviene la validazione professionale, come resta tracciata la provenienza di ogni dato. VINCOLO: si spiega il metodo, MAI le regole interne di estrazione — «leggiamo i campi che servono dalla bolletta» si dice, quali indizi usiamo per riconoscerli no. Il primo e fiducia, il secondo e know-how regalato.
- IL FOCUS D'ESEMPIO: sotto lo schema generale, il fascicolo di UN percorso con il selettore su quattro (Carbon Footprint come predefinito perche e il piu leggibile, poi ISO 9001, VSME e PdR 125). Ogni fascicolo dichiara anche COSA COMPONE l'AI Ver0 per quel percorso: cambiando scheda cambia il contenuto, non la grammatica — ed e cosi che si vede che il sistema e trasversale e non e nato per un solo servizio. Dati sempre di impresa fittizia.
**12.W.1 — REVISIONE DEI TESTI (21/08/2026, indicazioni del fondatore).**
- CLAIM /come-funziona: «Non e un assistente. E un'intelligenza costruita per questo.» con il sottotitolo che dichiara AI proprietaria specializzata sui documenti d'impresa e sulle norme che li governano.
- L'AI GIUSTIFICA QUALITA, PRECISIONE E TEMPI — MAI L'ECONOMICITA. Il legame «e la ragione per cui i prezzi possono essere questi» e stato rimosso: il prezzo si spiega da se con le nostre caratteristiche, e legare la tecnologia allo sconto svaluta entrambi.
- QUALITA DEGLI ELABORATI (mancava ovunque): sei fatti in `src/components/qualita-output.tsx`, un solo componente per home, /come-funziona e schede servizio — conformi alle norme citate per esteso, struttura professionale, ogni dato con la sua fonte, metodologia esplicitata, validati da un professionista, aggiornati quando la norma cambia. Tono fattuale: «struttura professionale» si verifica aprendo il documento, «la migliore del mercato» no e non si scrive. Vale il vincolo §13.7: «pronto per la certificazione», mai «certificato».
- PROGRAMMA PARTNER: nessun riferimento a provvigioni, percentuali o ritorni economici sulle pagine pubbliche. Il partner si racconta con gli strumenti (dashboard multi-cliente, percorsi standardizzati, output pronti, tempi) e con la qualita; le condizioni economiche si trattano in privato — al massimo «condizioni dedicate ai partner, su richiesta». Una percentuale scritta sul sito diventa un impegno verso chiunque passi di li.
- NOMENCLATURA: «motore» e una metafora, «AI Ver0» e un nome. Le occorrenze visibili sono ora ZERO su home, /come-funziona, /chi-siamo, /partner e schede servizio (resta solo nel nome di una classe CSS). Si usa «AI Ver0» o «la nostra AI proprietaria», e solo dove aggiunge informazione.
- POSIZIONAMENTO DIMENSIONALE: i percorsi sono gli stessi per tutte le dimensioni e reggono le esigenze delle imprese piu strutturate; le fasce di prezzo li rendono accessibili anche a chi ne restava fuori. Mai l'impressione di un prodotto «per piccoli».
- SEZIONE PREZZI IN HOME: «Pubblici, per fascia dimensionale, tutto incluso.» / «Li leggi, li confronti, decidi. Senza preventivi da aspettare.»

**12.Z — HOME ALLEGGERITA: IL PREZZO COME PRINCIPIO (21/08/2026).**
- IL CATALOGO ESCE DALLA HOME. Elenco e prezzi per servizio hanno una sola sede: la pagina Servizi. In home resta il PRINCIPIO — «I prezzi li trovi scritti. Prima di parlare con noi.» — con tre prove concrete e UNA sola CTA verso il catalogo.
- LA SEZIONE PARLA SOLO DI NOI. Tre caratteristiche dette come fatti nostri: (1) un prezzo chiaro e completo — canone unico, nessun costo nascosto, nessuna sorpresa a fine progetto; (2) tutto incluso nel canone — Sigillo, osservatorio bandi, aggiornamento dei documenti quando cambiano le norme, Kit e assistenza, con i nomi per esteso perche «tutto incluso» da solo e un aggettivo; (3) il prezzo segue il percorso — dal secondo anno il canone scende perche i dati sono gia nel sistema, e il rinnovo resta libero.
- REGOLA VINCOLANTE: NESSUN CONFRONTO ECONOMICO CON IL MERCATO e nessun giudizio, diretto o implicito, sul lavoro altrui. Non si mette il nostro prezzo accanto a quello di qualcun altro, non si citano cifre di terzi, non si insinua cosa farebbe o non farebbe un consulente. Il motivo non e la prudenza: un confronto sposta il discorso su qualcun altro proprio quando dovremmo parlare di noi, e le nostre caratteristiche reggono da sole. (Una versione precedente di questa sezione conteneva un confronto con gli ordini di grandezza del mercato e una frase sul preventivo come filtro: entrambi rimossi.)
- NESSUN NUMERO nella sezione, tranne il rimando «percorsi da X euro/mese» — calcolato dal listino, mai scritto a mano. Una sola CTA verso il catalogo.
- RITMO DELLA HOME, verificato leggendo il fondo reale di ogni sezione: soglia (scuro), lo Zero di Ver0 (chiaro), il Motore (scuro), consulenti veri (chiaro), il prezzo (scuro), solo standard (chiaro), il Sigillo (scuro), la chiusa (scuro), lista d'attesa (chiaro). La sezione dei Zeri e stata spostata SOPRA il Motore — nella sequenza «cosa rendiamo possibile» viene prima del meccanismo — e come effetto l'apertura non e piu due blocchi scuri di fila. Dalla chiusa e stato tolto l'elenco dei quattro Zeri, che ripeteva la sezione precedente: resta la sola riga che li tiene insieme.
- ANCORE: `/#canone` non esiste piu; i link da prezzo-box e catalogo-vetrina puntano a `/#prezzo`.

**12.Y — MARCHIO ESTESO, NAVIGAZIONE E PAGINA SICUREZZA (21/08/2026).**
- MARCHIO: il logotipo e il nome per esteso «Verzero» con lo zero canonico E1 come ultima lettera (variante B del brand book), in header, footer, dati strutturati e titoli. «Ver0» resta il MONOGRAMMA — favicon, Sigillo, targa, spazi stretti — e resta il nome del PRODOTTO dentro i testi (Sigillo Ver0, AI Ver0): nessuna sostituzione automatica nei contenuti. File: `public/brand/logo-verzero.svg`, componenti `Logo` e `Monogramma`.
- NAVIGAZIONE A CINQUE VOCI: Chi siamo, Come funziona, Servizi, Il Sigillo, Contatti, piu «Accedi» isolato a destra. «Home» e uscita — alla home ci si torna dal marchio, che ha l'etichetta accessibile giusta — e «Partner» pure, perche parla ai consulenti e non alle imprese: vive come sezione dentro Chi siamo, con `/partner` raggiungibile da li, dal footer e dalla pagina di accesso. Il menu mobile mostra le stesse cinque voci piu Accedi in evidenza.
- FOOTER COME MAPPA in quattro colonne: Servizi (dal catalogo, col taglio nel nome per non avere due voci identiche), L'azienda, Fiducia (Sigillo e Sicurezza), Legale (privacy, cookie, preferenze, condizioni). Regola: nessun link orfano, ogni pagina pubblica raggiungibile dal menu o dal footer.
- PAGINA /sicurezza + sezione in Chi siamo + link dallo step consensi del funnel. DUE LIVELLI: garanzie in linguaggio comune, «i dettagli tecnici» richiudibili. L'affermazione piu forte e la PROVA: l'isolamento fra imprese e coperto da 53 test automatici eseguiti a ogni rilascio, e la pagina dice cosa verificano. Chiusura con sei domande dirette e risposte di due righe.
- REGOLA VINCOLANTE (anche in CLAUDE.md): si dichiarano le GARANZIE, mai l'IMPLEMENTAZIONE. Vietati struttura del database e nomi di tabelle, testo o logica delle politiche, modelli AI e istruzioni, schemi di estrazione, soglie, costi per pratica, versioni, percorsi e nomi di file. Criterio: se un'informazione permette a un concorrente di replicare il metodo o a un attaccante di orientarsi, non va in pagina. Approfondimenti tecnici (questionari fornitori, audit IT) in documento riservato su richiesta. Nessun claim non dimostrabile.
- VERIFICHE PRESSO I FORNITORI (21/08/2026, contenuti in `src/lib/sicurezza.ts` con la data): Supabase — progetto in eu-west-1 (Irlanda), cifratura AES-256 a riposo e TLS in transito, ISO 27001 e SOC 2 Type 2, DPA disponibile. Anthropic — per impostazione predefinita input e output dei prodotti commerciali (API inclusa) NON sono usati per addestrare i modelli; unica eccezione le segnalazioni esplicite di feedback, che non inviamo. Vercel — le funzioni girano dove le si fissa e la predefinita e Washington: e stato aggiunto `vercel.json` con `dub1` (Dublino, accanto al database), altrimenti la pagina avrebbe dichiarato una cosa falsa. Resend — elabora NEGLI STATI UNITI su clausole contrattuali standard e quadro UE-USA: e il motivo per cui nelle email non vanno mai documenti ne dati d'impresa, e la pagina lo dice apertamente.

- DATI DI ESEMPIO NELLE PAGINE PUBBLICHE: solo imprese dichiaratamente inventate — oggi «Officina Lombardi S.r.l.», con partita IVA volutamente NON valida (una lettera in mezzo alle cifre: una partita IVA formalmente corretta potrebbe appartenere a qualcuno per caso) — e la parola «esempio» visibile accanto. Mai il nome di un'azienda reale, nemmeno come segnaposto. Le pagine pubbliche non leggono tabelle di clienti; unica eccezione `/verifica/[codice]`, dove mostrare l'impresa E il servizio. Regola permanente in CLAUDE.md.
- RITMO CHIARO/SCURO/CHIARO: l'hero non e un episodio isolato. Il fascio luminoso torna nella sezione del Motore e nella fascia del Sigillo, stessa implementazione con parametri calibrati; nelle sezioni chiare resta la versione tenue. La calibrazione dei preset scuri NON si giudica dall'opacita ma dal contrasto misurato del testo bianco della loro sezione: `tecnica` al 45% portava il bianco a 4,23:1 ed e stata abbassata al 36% (5,27:1); `tenueScura` sta al 32% (6,76:1). Sui fondi chiari resta la regola del 25%, perche li il testo e scuro e sottile e non c'e maschera a proteggerlo.
- SEZIONE MOTORE — INFOGRAFICA DEL SISTEMA, non il racconto di un caso. La versione precedente componeva un solo inventario GHG riga per riga: bella scena, argomento sbagliato. Ora tre colonne — COSA ENTRA (i documenti che hai gia, le banche dati ufficiali interrogate sul mandato, il tuo sito e i dati pubblici), IL MOTORE (AI Ver0, dominante e dichiarato PROPRIETARIO e specializzato, con le tre funzioni: legge e comprende, incrocia e verifica, compone secondo norma), COSA ESCE (piu percorsi, ognuno con la norma citata: UNI EN ISO 14064-1:2019, standard VSME EFRAG, UNI EN ISO 9001/14001/45001, UNI/PdR 125:2022) — e sotto la scena che vende davvero: «entri nel portale e il documento e gia composto», con l'anello alto e la parte chiara marcata «quello che serve da te». La quota mostrata e un esempio e lo dichiara.
- PRIMO IMPATTO IN HOME — LA SOGLIA SU FONDO SCURO (iterazione 4, 21/08/2026, sostituisce le versioni su fondo bianco). L'hero e l'unico blocco scuro dell'apertura: pino profondo `#0A2E1F` con leggero gradiente verso `#0C3927`, a piena larghezza. Il resto del sito resta chiaro — l'hero e una soglia, e una soglia si attraversa. NOTA APERTA: l'header e bianco e sticky, quindi sopra l'hero scuro resta una cucitura netta; si puo rendere scuro sulla sola home se il fondatore lo vuole.
- IL FASCIO DIVENTA LUCE: palette invertita (bianco con accenti menta accesa `#2FCF9A`), BAGLIORE ADDITIVO — le particelle si sommano al fondo invece di coprirlo, che su scuro e cio che le fa sembrare luce e non vernice — raggi da 1 a 6px, densita e velocita alzate. Le SCIE non costano una drawImage in piu: il canvas possiede il fondo e a ogni fotogramma lo ridipinge all'83%, cosi il fotogramma precedente si consuma invece di essere cancellato — le particelle lente si ricoprono da sole, le veloci lasciano un filo. Saturazione verificata: 0,01% di pixel bruciati.
- LA FORMA resta quella dell'iterazione 3: campo di rumore Perlin scritto in casa (`src/lib/rumore.ts`, nessuna libreria), fascio che muta — linea, ampiezza, larghezza, densita, sdoppiamento in due filamenti che si riuniscono — con scale temporali tutte diverse fra loro, e particelle che lo inseguono con INERZIA (strappo 0,15-0,20px per fotogramma: nessuno scatto). Una somma di sinusoidi, per quante ne metti, resta riconoscibile in pochi secondi; il rumore no.
- L'INGRESSO USA LA STESSA FISICA: all'apertura le particelle sono disperse fuori campo e ci arrivano da sole in circa 1,7s. Non e un'animazione a parte, quindi non esiste un istante in cui «finisce l'ingresso e comincia il moto».
- IL CLAIM HA DUE PESI: «I tuoi consulenti» in peso normale (moss), «in cloud.» in bianco pieno a circa 1,6 volte la scala e peso massimo. L'occhio ci cade sopra perche e piu GRANDE, non perche e colorato: il colore l'avrebbe reso piu chiaro, cioe piu fragile sopra le particelle. L'accento menta e una SOTTOLINEATURA tracciata a mano (due passate sfalsate, mai un rettangolo), non un cambio di colore del testo. CTA: bianco pieno la principale, menta accesa la secondaria.
- LE MASCHERE RESTANO, tarate sul fondo: particelle chiare dietro testo bianco abbassano il contrasto esattamente come le scure sotto testo scuro. I margini stanno in configurazione (`maschera` in `ConfigOnda`): sul chiaro 1,5/1,9/0,06, sulla soglia 1,35/1,65/0,16 — cioe molto piu onda dietro il claim. Escono da una ricerca, non da un'idea: con la maschera del fondo chiaro il contrasto restava a 9-12:1 contro i 4,5 richiesti, cioe si tratteneva l'onda per niente. E il `minimo` — quanto resta dell'onda SOTTO le lettere — non sposta il risultato: a sporcare il testo sono le particelle NEGLI SPAZI fra le righe, che ci arrivano col bagliore largo tre raggi. Conta l'ESTENSIONE, soprattutto quella verticale.
- REGOLA PER SCHERMI STRETTI: sotto i 640px una maschera SOLA sul blocco, non una per riga. Su un telefono il claim occupa quasi tutta la larghezza, quindi fra una riga e l'altra non c'e spazio in cui l'onda si possa vedere.
- CONTRASTO MISURATO IN MOVIMENTO, punto peggiore, tre minuti di simulazione con l'inerzia vera, quattro larghezze (375, 1280, 1440, 2560): 5,47-7,15:1 su moss e 6,36-8,32:1 sul bianco pieno. Sui PIXEL VERI del canvas nel browser: 5,48:1 e 6,37:1 a 1280; 5,57:1 e 6,48:1 a 2560 con buffer 5480x1334, cioe risoluzione piena del dispositivo.
- COSTO PER FOTOGRAMMA: 0,10-0,32ms di calcolo piu 0,2-0,3ms di rasterizzazione in mediana (p95 2,2ms), cioe circa il 4% dei 16,7ms. Particelle: 368 sotto i 640px, 805 fino a 1800, 897 oltre. La forma del fascio si calcola UNA volta per particella per fotogramma e si ricorda: senza memoria veniva valutata quattro volte e il calcolo costava 0,77ms invece di 0,32.
- DUE CALIBRAZIONI confrontabili dal vivo con `?onda=contenuta` sulla home: piena (predefinita) e contenuta (stesso movimento, opacita al 70%, raggi all'85%).
- I MOMENTI PROGETTATI: (1) primo impatto; (2) LA SCENA MADRE — il foglio che si compila campo per campo con la fonte accanto e il timbro «conforme allo standard» alla fine, dichiarata ESEMPIO in pagina; (3) il numero che sale, che riparte dall'ultima percentuale vista e non da zero (memoria locale per anello) e mostra comunque subito il valore vero; (4) il riconoscimento al primo accesso — «Abbiamo gia trovato N dati sulla tua impresa», campi in sequenza con la fonte; (5) la conferma di un dato — spunta che si disegna, riga che cambia stato, contatore che scende, con risposta immediata e azione server dietro; (6) il Sigillo, i cui segmenti si disegnano uno dopo l'altro dove il Sigillo e il soggetto.

**12.C — CORREZIONI DI SOSTANZA (portale, periodo, nomenclatura AI, servizio rating, servizi inclusi).**
- PERIODO DI RENDICONTAZIONE != DATA DI ELABORAZIONE. Ogni documento (carbon, bilancio VSME, manuali, rating circolarita) si riferisce a un ANNO SOLARE CHIUSO gennaio-dicembre. Il portale chiede esplicitamente l'ANNO DI RENDICONTAZIONE, proponendo di default l'ultimo anno chiuso (oggi: 2025), e lo mostra sempre nel titolo del documento e nel fascicolo ("Inventario GHG 2025 · elaborato nel 2026"). I documenti richiesti al cliente si riferiscono a quell'anno (es. bollette dei 12 mesi dell'anno di rendicontazione). Mai confondere i due periodi in nessun testo o interfaccia.
- NOMENCLATURA DELL'AI: ridurre le ripetizioni di "Motore". Il sistema si chiama "AI Ver0" (o "l'AI proprietaria Ver0" per esteso, quando serve chiarire che e proprietaria e specializzata). Nel portale si nomina solo dove aggiunge informazione (badge di provenienza, sezioni in cui sta lavorando), mai come intercalare.
- SERVIZIO "RATING": Verzero NON e un'agenzia di rating e non emette rating propri. Il servizio del bundle si chiama e si descrive come PREPARAZIONE E MIGLIORAMENTO DEL PROFILO ESG per i questionari e i rating DI TERZE PARTI (EcoVadis, Synesgy/CRIF, Open-es, CDP, questionari bancari e di filiera): componiamo le risposte dai dati gia raccolti, evidenziamo le lacune e prepariamo il dossier; il punteggio lo assegna sempre l'ente terzo. Vietata ogni formulazione che suggerisca un rating Ver0.
- SERVIZI INCLUSI ≠ DOCUMENTI ACQUISTATI: Kit di Comunicazione, Osservatorio bandi e Sigillo sono STRUMENTI DI RETENTION inclusi nel canone e non compaiono mai nell'elenco dei documenti/deliverable che il cliente sta pagando (ne nel conteggio "Documento X di Y", ne nei fascicoli). Vivono in una fascia separata del portale ("Incluso nel tuo abbonamento").
- DASHBOARD — DENSITA VISIVA: il portale non deve essere un muro di testo con caratteri uniformi. Regole: gerarchia tipografica marcata (display Fraunces per i titoli, corpo piu piccolo e grigio per il secondario), ICONE coerenti su ogni sezione e stato, INDICATORI VISIVI dove ci sono numeri (anello di completamento, barre, mini-grafici di andamento dove esistono serie storiche), zone di INPUT chiaramente distinte da quelle di LETTURA (campi con bordo e sfondo dedicati, pulsanti evidenti), colore usato per significato (menta = fatto dall'AI, ambra = serve a te, pino = struttura). Criterio: un utente che apre il portale per la prima volta deve capire in 5 secondi dove inserire dati, dove leggere risultati e cosa manca.

**12.C.1 — STATO DELLE CORREZIONI DI SOSTANZA (19/08/2026).**
- PERIODO: colonna `organizations.anno_rendicontazione` (default: ultimo anno solare chiuso). Titoli nella forma «Inventario GHG 2025 · elaborato nel 2026»; le richieste documentali citano l'anno («bollette dei 12 mesi del 2025»); il campo si cambia dalla scheda impresa e ricompone tutte le bozze. Helper unico in src/lib/periodo.ts.
- NOMENCLATURA: «AI Ver0» al posto di «Motore» nei testi visibili, e nominata SOLO dove aggiunge informazione (badge di provenienza, sezioni in lavorazione, pannello di recupero); altrove tolta del tutto invece che sostituita, perche ripetuta diventa un intercalare. Nomi di file e componenti interni restano.
- RATING: il componente del bundle e ora «Profilo ESG per questionari e rating di terze parti» (EcoVadis, Synesgy, Open-es, CDP, questionari bancari): componiamo le risposte, segnaliamo le lacune, prepariamo il dossier. Nessuna formulazione suggerisce un punteggio Ver0, ne nel portale ne nel catalogo ne in vetrina.
- SERVIZI INCLUSI: Kit di comunicazione, osservatorio bandi e Sigillo NON sono deliverable: fuori dai componenti del bundle e dal conteggio «Documento X di Y» (che passa da 4 a 3), raccolti nella fascia «Incluso nel tuo abbonamento» della Panoramica.
- DENSITA VISIVA: primitive condivise in _ui.tsx — TestataSezione con icona, ZonaLettura (bianca) vs ZonaInput (salvia tratteggiata), Occhiello, Metrica con barra, LegendaColori. Il patto sul colore e dichiarato una volta in Panoramica: menta = fatto dall'AI, ambra = serve a te, pino = struttura.
...
- MOBILE: le sezioni sticky/scrollytelling degradano su mobile a sequenza statica impilata e leggibile; nessun effetto che comprometta fluidita o leggibilita sotto i 768px. PRECISAZIONE (21/08/2026, superata per la sezione dello Zero — v. 12.O.1): "niente narrazione sticky" non significa "niente movimento" — era il difetto segnalato sui sei Zeri, che sotto i 768px comparivano tutti insieme perche la rinuncia alla narrazione spegneva anche l'unico meccanismo di comparsa presente. Sotto la soglia le fasi restano impilate ma si accendono una alla volta con il motore dei reveal (`src/lib/reveal.ts`), condiviso con il resto del sito: una sola taratura, non due.
- MOTORE DEI REVEAL (fonte unica `src/lib/reveal.ts`, usato da `RevealObserver` e dallo scrollytelling stretto). Taratura pensata per schermi corti: `threshold: 0` — decide il BORDO che entra, non una frazione dell'area, che su un blocco alto due schermate arriva a lettura gia avvenuta; `rootMargin` inferiore nullo sotto i 720px di altezza, perche su un telefono la corsa di scorrimento e breve e un margine negativo si mangia l'animazione; al montaggio si esclude solo cio che e DAVVERO gia in vista (altezza piena, non il 92%). Lo scaglionamento nasce dall'ORDINE REALE di comparsa — indici crescenti dall'alto verso il basso scritti in `--vz-i`, tradotti in ritardo dal token `--vz-scaglione` — non da una griglia decisa a tavolino. Tre reti di sicurezza, nell'ordine: l'observer; un controllo manuale agganciato a `scroll`/`scrollend` per quando le consegne si diradano (scorrimento inerziale iOS); un paracadute che rivela tutto se l'observer non consegna MAI. Regola invariata: lo stato nascosto si applica solo da JavaScript, mai in CSS puro — se il codice non gira, tutto resta visibile.

**12.O.1 — IL NASTRO DELLO ZERO E IL LIMITE DEL MOVIMENTO LEGATO ALLO SCORRIMENTO (22/08/2026).**
- LA SEZIONE DELLO ZERO NON E PIU UNA NARRAZIONE. Le declinazioni dello Zero vivono in un BANNER A SCORRIMENTO CONTINUO orizzontale (`NastroZero`, contenuti in `src/lib/zeri.ts`), da destra a sinistra, in CSS puro: nessun JavaScript, nessun observer, nessuna scroll-timeline. Movimento lento e costante, ciclo senza salti (due gruppi identici, traslazione -50%, separatori dentro le voci perche i due gruppi restino identici al pixel), pausa al passaggio del puntatore solo dove `hover: hover`, e con «riduci movimento» il nastro va a capo e si legge come elenco statico — fermo e ritagliato nasconderebbe meta delle voci, che e contenuto perso.
- UNA SOLA IMPLEMENTAZIONE, mobile e desktop. Tenere il palco sticky sul grande e il nastro sul piccolo avrebbe significato due tarature da allineare a mano: e da li che era nato il difetto.
- LEZIONE GENERALE: un movimento che dipende dalla POSIZIONE DELLA PAGINA e trasporta contenuto e fragile per natura — chi scorre veloce lo salta, chi scorre piano lo vede a strappi, e ogni correzione aggiunge una rete di sicurezza sopra la precedente. Il movimento d'ambiente, che non dipende da nulla, non ha quel problema. Lo scrollytelling resta ammesso SOLO dove il contenuto e comunque leggibile da fermo (oggi: il Sigillo).
- OGNI DECLINAZIONE VIAGGIA CON LA SUA DEFINIZIONE: nel nastro titolo e nota non si separano mai, perche «Zero effort» da solo e vietato.

**12.O.2 — ETICHETTE CON UN SOGGETTO, E IL RISULTATO SI MOSTRA (22/08/2026, feedback di revisione professionale).**
- NIENTE GERGO DA SCHEMA DI FLUSSO. «Cosa entra», «chi lavora», «cosa esce», «cosa ottieni» descrivono la macchina e non dicono a nessuno cosa deve fare. Le fasi si nominano con un soggetto: «Tu porti quello che hai gia» → «La nostra AI proprietaria legge, incrocia e compone» → «Tu ricevi». Vale ovunque, schede servizio comprese.
- «TU RICEVI» MOSTRA IL DOCUMENTO, NON L'ELENCO. Al posto della lista di percorsi con la norma accanto c'e la bozza dell'elaborato (`DocumentoEsito`): impaginazione realistica, indice, riferimento normativo in evidenza, tabella dati, pagina di validazione. Accanto, piu piccoli e dichiaratamente accessori, il Kit di comunicazione e il Sigillo. Impresa inventata e parola «esempio» visibile; norme citate in modo generico.
- LA QUALITA DEGLI ELABORATI NON HA PIU UNA SEZIONE IN HOME: la home e manifesto, e il concetto sta in una riga dentro «Tu ricevi» (documenti che reggono la lettura di banca, capofiliera, stazione appaltante, organismo di certificazione). Il contenuto esteso vive in /come-funziona e nelle schede servizio.
- CHECKLIST DOCUMENTALI FUORI DAL SITO PUBBLICO: v. la regola «metodo si, mappature no» in CLAUDE.md. Il fascicolo per percorso e la voce «Cosa ti chiederemo» delle schede servizio sono stati rimossi; la lista precisa resta nel portale, dopo l'attivazione. Questa regola SUPERA il punto di 12.P che voleva la checklist nella scheda servizio.

**12.O.3 — VISIBILITA NELLE RISPOSTE GENERATE — AEO/GEO (22/08/2026).**
- ROBOTS PER FAMIGLIE (`src/app/robots.ts` + `src/lib/ai-canali.ts`). Tre gruppi dichiarati uno per uno invece della sola regola generica: RICERCA E CITAZIONE (OAI-SearchBot, ChatGPT-User, Claude-SearchBot, Claude-User, PerplexityBot, Perplexity-User, Bingbot, Googlebot), ADDESTRAMENTO (GPTBot, ClaudeBot, Google-Extended, Applebot-Extended), TUTTI GLI ALTRI. Tutti ammessi, tutti con le stesse esclusioni: /acquista/, /login, /dashboard, /api/, /auth/. La scelta sull'addestramento e deliberata: per un marchio nuovo la presenza nella conoscenza dei modelli vale piu del controllo su contenuto gia pubblico. `host` non si dichiara (direttiva non standard che sposterebbe `Sitemap` a meta file).
- CONTENUTI CITABILI. Ogni pagina servizio apre con un blocco «In breve» (`InBreve`) che risponde in modo autoconclusivo alle domande naturali: quanto costa, a chi serve, cosa consegna Verzero, su quali norme, cosa serve dall'impresa, cosa NON e compreso. Le voci si compongono da catalogo e listino in `src/lib/faq-servizio.ts` e sono le STESSE marcate con FAQPage: il markup non dichiara mai una domanda che non sia in pagina. Regola di scrittura: soggetto esplicito, oggetto per esteso, nessun rimando al contesto della pagina.
- ENTITA UNICA. `SITO.descrizione` e la descrizione dell'ORGANIZZAZIONE — diversa dalle meta description, che descrivono pagine — e va usata identica in dati strutturati, llms.txt e futuri profili esterni. `Organization` con `@id` stabile, `knowsAbout`, `logo` come ImageObject; `WebSite` con `publisher` sullo stesso `@id`; `Service.provider` sullo stesso `@id`. `PROFILI_UFFICIALI` e vuoto: `sameAs` compare solo quando i profili esistono davvero.
- LLMS.TXT (`/llms.txt`, generato da `pagine-pubbliche.ts` + catalogo). Segnale complementare, non standard, nessuna aspettativa di effetto immediato; costo di manutenzione nullo perche si genera dalle fonti uniche. Va aggiunto ai percorsi pubblici del proxy, come robots.txt e sitemap.xml, altrimenti torna la pagina di login.
- MISURAZIONE. Due eventi distinti nel registro: `arrivo_ai` (referrer da chatgpt.com, perplexity.ai, claude.ai, gemini/vertexaisearch, copilot — lo manda il browser, una volta per sessione) e `crawler_ai` (user agent riconosciuto — lo scrive il server con `after()`, dopo che la risposta e partita, senza impronta del visitatore perche non c'e nessun visitatore). Una scansione non e una visita: sommarle significa credere di avere traffico.
- VERIFICA A MONTE (22/08/2026): produzione risponde 200 a GPTBot, OAI-SearchBot, ClaudeBot, Claude-SearchBot, PerplexityBot, Bingbot e Googlebot su home, robots.txt e scheda servizio; il corpo servito a GPTBot e identico byte per byte a quello servito a un browser (140.898 byte); nessuna intestazione `x-robots-tag`, nessuna protezione Vercel attiva, nessun challenge. Da rifare dopo ogni cambio di configurazione della piattaforma.

**12.O.4 — LO ZERO IN DUE RESE, E LA REGOLA GENERALE DELL'ADATTAMENTO (22/08/2026).**
- SU SCHERMO LARGO (da 768px) la sezione dello Zero torna alla NARRAZIONE ALLO SCORRIMENTO: palco sticky, una declinazione alla volta grande quanto un titolo, zero gigante in filigrana, barra di avanzamento. SU SCHERMO STRETTO resta il NASTRO a scorrimento continuo (12.O.1), che li e la soluzione che regge. Le declinazioni vengono da `src/lib/zeri.ts` in entrambi i casi: cambia la presentazione, mai il contenuto. Sul largo la nota diventa frase compiuta (maiuscola e punto) — trasformazione di presentazione, non un secondo testo.
- LA SCELTA LA FA IL CSS (`hidden md:block` / `md:hidden`), non JavaScript: entrambe le rese stanno nel markup e `display: none` toglie quella inattiva dall'albero di accessibilita e ne ferma le animazioni. Una scelta fatta dopo l'idratazione darebbe sfarfallio e, senza JS, nessuna delle due.
- IL RIPIEGO NON E PIU LEGATO ALLA LARGHEZZA. Quando la narrazione non parte — schermo stretto, scroll-timeline assenti (Safari), o timeline presenti ma inerti — le fasi si accendono comunque una alla volta con il motore dei reveal. Prima quel ripiego esisteva solo sotto i 768px: sopra, dove le scroll-timeline mancano, le sei declinazioni comparivano tutte insieme. `revealSuStretto={false}` lo disattiva SOLO per il caso stretto, dove la resa e gia un'altra.
- IL GUARDIANO MISURA L'EFFETTO, NON L'API. Confrontava `timeline.currentTime` con la geometria della sezione: in Chrome quel valore letto dal thread principale resta indietro (misurato: costante a 0,492 mentre le fasi si avvicendavano correttamente), e il guardiano spegneva narrazioni sane. Ora guarda le OPACITA delle fasi: se scorrendo dentro la sezione il quadro cambia, il meccanismo e reale e i controlli finiscono; se dopo cinque scorrimenti utili e identico a se stesso, la timeline e inerte e si passa al ripiego.
- REGOLA GENERALE (vale oltre questo caso): quando desktop e mobile hanno vincoli diversi si ADATTA LA PRESENTAZIONE, non si degrada il desktop per uniformarlo al mobile. Condizioni: contenuto unico da fonte unica, scelta in CSS, e passaggio fra le rese verificato — mai due rese insieme, mai contenuto invisibile, mai lo stesso testo letto due volte.

**12.O.5 — IL PALCO ANCORATO, DUE ESECUTORI E UNA CURVA SOLA (22/08/2026).**
- COMPORTAMENTO. Da 768px in su la sezione dello Zero si ancora: contenitore alto piu schermate (`--steps * 72svh`), palco in `position: sticky; top: 0`, e lo scorrimento fa avanzare le declinazioni dentro la sezione ferma. Ogni fase entra e esce in dissolvenza e traslazione IN BASE ALLA PROGRESSIONE, mai a un timer. L'ULTIMA non esce: resta finche la sezione si sblocca (fotogrammi `ULTIMA`) — con la curva normale il palco si svuotava proprio nel tratto conclusivo. Nessun blocco dello scorrimento e nessun hijacking: gli ascoltatori sono passivi, non si intercetta nulla, si esce dalla sezione continuando a scorrere.
- DUE ESECUTORI, UNA CURVA. I fotogrammi sono dichiarati UNA volta (`Fotogramma[]`) e serviti a due motori: la scroll-timeline CSS dove esiste (Chromium: animazioni WAAPI su `ViewTimeline`, fuori dal thread principale) e il CALCOLO DELLA PROGRESSIONE dove non esiste (WebKit/Safari: ascoltatore passivo, un `requestAnimationFrame` per fotogramma, sei opacita da scrivere). Scrivere la curva due volte avrebbe prodotto due animazioni diverse a seconda del browser, senza errori da nessuna parte. La progressione e quella della fascia "contain" — da bordo alto contro bordo alto a bordo basso contro bordo basso — cioe esattamente il tratto in cui il palco resta ancorato: per questo i due modi mostrano la stessa cosa nello stesso punto.
- IL GUARDIANO ORA DEGRADA MEGLIO. Se la timeline esiste ma resta inerte, non si rinuncia piu al palco: si cancellano le animazioni e si passa al calcolo, che fa la stessa cosa sullo stesso tratto. Bastano tre letture identiche dentro il tratto ancorato per decidere (prima cinque: si poteva alzare l'asticella perche il rimedio non e piu una rinuncia).
- PARACADUTE INVARIATO: `data-live` si accende SOLO quando e certo che qualcuno fara comparire le fasi, e se il calcolo va in eccezione si spegne — senza `data-live` il CSS non nasconde piu nulla. Con «riduci movimento» la sezione resta statica, alta una schermata, con tutte le declinazioni visibili.
- LA TRAPPOLA CHE LO AVEVA ROTTO: un `overflow-hidden` sulla sezione (aggiunto per la fascia del nastro) annullava insieme il `position: sticky` del palco E la scroll-timeline, che diventava inerte perche il suo contenitore di scorrimento era quell'elemento che non scorre. Nessun errore da nessuna parte; il guardiano vedeva il quadro fermo e passava al ripiego impilato, mascherando la causa. Regola in CLAUDE.md.
- COLLAUDATO con scorrimento vero (non ridimensionando) su WebKit e Chromium a 1440x900: palco fermo a 0 per tutta la corsa, sei declinazioni che si avvicendano una alla volta, pagina ferma = quadro fermo, indietro = quadro indietro, zero posizioni di scorrimento alterate, ultima declinazione ancora in scena oltre la sezione. Stessa verifica su /sigillo, che usa la stessa impalcatura: i cinque segmenti "keep" si accumulano e le cinque fasi di testo si avvicendano.
