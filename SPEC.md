...
- LE TRE PROVE: (1) il confronto con gli ordini di grandezza del mercato della consulenza tradizionale (SPEC §12.S), (2) cosa include il canone senza costi aggiuntivi — il vecchio blocco «il canone» non sparisce, diventa questa prova, altrimenti sarebbe ripetizione, (3) il ciclo di vita: dal secondo anno costa meno, disdetta libera dopo i primi dodici mesi.
- I PREZZI VENGONO DA `pricing.ts`, mai scritti a mano nel componente: un numero ricopiato e un numero che un giorno mentira. E il confronto mostra anche il caso in cui il margine e stretto (manuale ISO 9001, dove siamo al minimo della forbice di mercato) e lo dice: un confronto che regge vale piu di uno che impressiona.
- MAI DENIGRARE LA CONSULENZA: la differenza di prezzo si spiega col METODO — automazione e banche dati abbattono il costo di erogazione — non con l'avidita di qualcuno. Un consulente che lavora su misura e in azienda fa un altro mestiere e vale quello che costa. E anche piu credibile.
