...
**Limiti di uso corretto — contrattuali, in documenti e mai in valuta.** Ogni percorso attivo comprende, per anno di rendicontazione, **150 documenti elaborati** e **20 generazioni**; le dotazioni dei percorsi si sommano. Sono sei e sette volte l'uso reale misurato (25 documenti, 3 generazioni), perché il loro scopo non è razionare ma dare un tetto certo al costo variabile. Il superamento è a gradini e non blocca mai: oltre la dotazione le letture entrano in **coda a bassa priorità** («arrivano un po' più tardi, ma arrivano tutte»); oltre il doppio si chiede di **sentirsi**, e il lavoro in corso continua. Contatore discreto in portale, in documenti. **Caso peggiore certo: $39,60 per percorso/anno**, lineare nei percorsi ($158 con quattro). Testo contrattuale in `/termini`, sezione «Quanto puoi elaborare» — **da far validare al legale**.
