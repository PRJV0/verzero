...
- PRIMO IMPATTO IN HOME: direzione C + B del brief. Il claim si compone parola per parola (la PRIMA parola senza ritardo, per non rinviare la misura del contenuto principale), la parola-Zero si trasforma nello zero canonico del marchio (il testo resta nel DOM per chi legge con uno screen reader; la larghezza della parola e riservata, quindi il cambio non sposta nulla), e sotto ci sono due masse di colore che derivano su cicli di 42 e 64 secondi piu filigrane vettoriali che ruotano in due minuti. Nessun video, nessuna libreria: la foto dell'hero NON entra in scena e resta `priority`, perche e il candidato piu probabile a contenuto principale.
