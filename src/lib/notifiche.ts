...
const FIRMA_HTML = [
  `<p style="margin-top:24px">— <a href="${publicEnv.siteUrl}" style="color:#21544F;text-decoration:none"><strong>${SITO.monogramma}</strong></a>`,
  `<br><span style="color:#21544F">${SITO.payoff}</span></p>`,
].join("");
