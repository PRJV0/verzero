...
const FIRMA_HTML = [
  `<p style="margin-top:24px">— <a href="${publicEnv.siteUrl}" style="color:#065B3C;text-decoration:none"><strong>${SITO.monogramma}</strong></a>`,
  `<br><span style="color:#065B3C">${SITO.payoff}</span></p>`,
].join("");
